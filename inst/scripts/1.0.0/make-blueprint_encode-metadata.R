df <- data.frame(
    ...
    RDataPath = file.path("celldex", "blueprint_encode","1.0.0", c("logcounts.rds", "coldata.rds")),
    BiocVersion="3.10", 
    Genome=NA, 
    SourceType="RDA", 
...
write.csv(file="../../extdata/1.0.0/metadata-blueprint_encode.csv", df, row.names=FALSE)
